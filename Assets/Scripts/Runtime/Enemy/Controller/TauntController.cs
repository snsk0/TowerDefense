...
using Runtime.Enemy.State.Taunt;
using Runtime.Enemy.Component.Attack;


namespace Runtime.Enemy.Controller
{
    public class TauntController : EnemyController
    {
        //ステートマシンのセットアップ
        private void Awake()
        {
